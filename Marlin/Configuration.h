...
#define STRING_CONFIG_H_AUTHOR "pophip22@outlook.fr" 
...
#define CUSTOM_MACHINE_NAME "Neva Magis MKS BASE 1.6"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like http://www.uuidgenerator.net/version4
#define MACHINE_UUID "88e8395c-430f-4f0a-af78-caa16d62dec5"
...
// >>> M665 H232 R56
// SENDING:M665 H232 R56
// SENDING:G33
// G33 Auto Calibrate
// Checking... AC
// .Height:232.00  Ex:+0.00  Ey:-8.53  Ez:-8.85  Radius:56.00
// .               Tx:+0.02  Ty:-0.23  Tz:+0.21
// Iteration : 01                                std dev:6.384
// Iteration : 02                                std dev:0.870
// Iteration : 03                                std dev:1.268
// Calibration OK                                rolling back.
// .Height:225.02  Ex:+0.00  Ey:-9.92  Ez:-10.24  Radius:56.62
// .               Tx:+0.01  Ty:+0.04  Tz:-0.05
// Save with M500 and/or copy to Configuration.h
  ...
  #define DELTA_HEIGHT 232.0             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  #define DELTA_SMOOTH_ROD_OFFSET 147.10 // Dagoma parameters
  #define DELTA_EFFECTOR_OFFSET 32.11 // Dagoma parameters
  #define DELTA_CARRIAGE_OFFSET 21.12 // Dagoma parameters

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS (DELTA_SMOOTH_ROD_OFFSET-(DELTA_EFFECTOR_OFFSET)-(DELTA_CARRIAGE_OFFSET)) //meas 175-180
...
#define DEFAULT_XYZ_STEPS_PER_UNIT 80.0 // lcd dummy


#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.0, 80.0, 80.0, 98.0}  // Dagoma
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          {333, 333, 333, 170} // Dagoma
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000,1000,1000,10000 } // Dagoma
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_SCRIPT "M600 L0 P18" // settings from dagoma
